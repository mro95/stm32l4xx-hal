...
use crate::gpio::{Input, Floating, Analog};
        ...
        PIN: Channel<Adc<crate::device::ADC>, ID = u8>
{
    ...
    fn read(&mut self, pin: &mut PIN) -> nb::Result<WORD, Self::Error> {
        ...
        self.adc.cfgr.modify(|r, w| unsafe { w.align().clear_bit().res().bits(0b00).cont().clear_bit() });
        self.adc.sqr1.modify(|r, w| unsafe { w.sq1().bits(PIN::channel()) });
        self.adc.cfgr2.modify(|r, w| unsafe { w.rovse().set_bit().ovsr().bits(0b011) });
